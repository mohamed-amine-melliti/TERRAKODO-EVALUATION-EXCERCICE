<template>
  <div class="bg-white dark:bg-dark-grey rounded-lg p-1">
    <div class="p-5 pr-3 flex flex-col gap-6 max-h-[90vh] overflow-y-auto ">
      ...
      <p class="text-medium-grey dark:text-white text-xs font-bold">Description :</p>
      ...
      <p v-if="boardsStore.getTask?.description" class="text-medium-grey text-sm">{{ boardsStore.getTask.priority }}
      </p>

      <p class="text-medium-grey dark:text-white text-xs font-bold">Date Of Completion :</p>

      <p v-if="boardsStore.getTask?.description" class="text-medium-grey text-sm">{{ boardsStore.getTask.dateOfCompletion }}
      </p>
